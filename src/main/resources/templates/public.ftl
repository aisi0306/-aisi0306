    ...
    <div class="n-public">
        <form class="m-form m-form-ht" id="form" method="post" action="/publicSubmit" onsubmit="return false;" autocomplete="off">
            ...
            <div class="fmitem">
                ...
                <div class="fmipt">
                    <input class="u-ipt ipt" name="remark" placeholder="2-140字符"/>
                </div>
            </div>
            <div class="fmitem">
            ...
            <div class="fmitem">
                ...
                <div class="fmipt" id="urlUpload">
                    <input class="u-ipt ipt"  name="pictureUrl" placeholder="图片地址"/>
                </div>
            ...
            <#--<div class="fmitem">
                <label class="fmlab">促销价：</label>
                <div class="fmipt">
                    <input class="u-ipt price" name="salePrice" />元
                </div>
            </div>-->
