...
<#include "include/header.ftl"><div class="g-doc">
    ...
    <#else>
    <div class="n-public">
        <form class="m-form m-form-ht" id="form" method="post" action="/updateContent?id=${product.id}" onsubmit="return false;" autocomplete="off">
            <div class="fmitem">
            ...
            <div class="fmitem">
                ...
                <div class="fmipt">
                    <input class="u-ipt ipt" name="summary" value="${product.remark}" placeholder="2-140字符"／>
                </div>
            </div>
            <div class="fmitem">
            ...
            <div class="fmitem">
                ...
                <div class="fmipt" id="urlUpload">
                    <input class="u-ipt ipt"  name="image" placeholder="图片地址" value="${product.pictureUrl}"/>
                </div>
            ...
            <div class="fmitem">
                ...
                <div class="fmipt">
                    <textarea class="u-ipt" name="detail" rows="10" placeholder="2-1000个字符">${product.text}</textarea>
                </div>
            </div>
            <div class="fmitem">
        ...
        <span class="imgpre"><img src="${product.pictureUrl}" alt="" id="imgpre"></span>
    </div>
    </#if>
</div>
